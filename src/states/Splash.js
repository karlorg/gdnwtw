...
export default class extends Phaser.State {
  ...
  preload () {
    ...
    //
      ...
      this.load.image('run hint', 'assets/images/run hint.png');
      ...
      this.load.spritesheet('cloud', 'assets/images/cloud.png', 8, 8, -1, 0, 0);
      ...
      this.load.audio("kid pain 0", "assets/sound/kid pain 0.ogg");
      for (const i of [...Array(7).keys()]) {
	  this.load.audio(`kid idle ${i}`, `assets/sound/kid idle ${i}.ogg`);
      }
  }
